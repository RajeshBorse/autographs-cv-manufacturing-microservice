...
public class NewCVManufacturingDTO {
    ...
    public NewCVManufacturingDTO() {
    }

    public NewCVManufacturingDTO(String id, String year, String month, String newCVManufacturingCount) {
        this.id = id;
        this.year = year;
        this.month = month;
    ...
    public String toString() {
        return "NewCVManufacturingDTO{" + "id='" + id + '\'' + ", year='" + year + '\'' + ", month='" + month + '\'' + ", newCVManufacturingCount='" + newCVManufacturingCount + '\'' + '}';
    }
